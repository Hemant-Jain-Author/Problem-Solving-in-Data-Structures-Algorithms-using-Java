public class Demo {
	...
	public static String reverseString(String str) {
		...
		reverseStringUtil2(a);
		String expn = new String(a);
		return expn;

	}

	public static void reverseStringUtil2(char[] a) {
		int lower = 0;
	...
	public static void main(String[] args) {
		System.out.println(matchExp("*ello?", "zdfsdfsdhellox"));
		System.out.println(match("hellappleappleappleapplexxappleapplexxxyyyxyyy",
				"hellappleappleappleapplexxxyyy"));
